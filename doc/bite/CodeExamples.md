...
In the agent-based management module of iLand (https://iland-model.org/ABE) we used the following JavaScript description to cut all the trees in a stand affected by the biotic agent and exceeding the threshold given above:
