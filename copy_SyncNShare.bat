...
copy /Y C:\dev\iland-model\src\iland\build\Desktop_Qt_6_7_2_llvm_mingw_64_bit-Release\release\iland.exe %DEST_FOLDER%
copy /Y C:\dev\iland-model\src\ilandc\build\Desktop_Qt_6_7_2_llvm_mingw_64_bit-Release\release\ilandc.exe %DEST_FOLDER%
