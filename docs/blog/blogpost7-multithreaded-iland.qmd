...
Did I already mention, that [Qt](../wiki/qt.qmd) is just great? The issue that made me state this here is [Multithreading](http://en.wikipedia.org/wiki/Multithreading_(computer_hardware). As the number of cores per CPU is very likely to [increase further](http://en.wikipedia.org/wiki/Multi-core), the issue of parallel computation gains importance. Actually, parallelism is one of the more important conceptual goals of the [iLand](../wiki/startpage.qmd)-development.
