...
The API documentation for this object moved: [Management object](../apidoc/classes/iland/management.qmd).
...
**int loadFromMap[Map](../apidoc/classes/iland/map.qmd) map, standID)**
Load all trees that are located on grid pixels with the value *standID* on the grid *map*.
See also: [Map](../apidoc/classes/iland/map.qmd)
...
**killSaplings[Map](../apidoc/classes/iland/map.qmd) map, standID)**
Kill all saplings (i.e. trees <4m) which are located on grid pixels with the value *standID* on the grid *map*.
See also: [Map](../apidoc/classes/iland/map.qmd)

**removeSoilCarbon[Map](../apidoc/classes/iland/map.qmd) map, standID, SWDfrac, DWDfrac, litterFrac, soilFrac)**
...
**slashSnags[Map](../apidoc/classes/iland/map.qmd) map, standID, slash_fraction)**
...
add saplings of species *species* on the polygon *mapId* of the polygonal [map](../apidoc/classes/iland/map.qmd)*map*. The function adds *n_ha* cohorts/ha (on the same number of 2m pixels). The added trees have the given *height* (in m) and *age* (in years).
...
We use [CSVFile](../apidoc/classes/iland/csvfile.qmd) to load a list of trees represented by Ids (see [tree variables](tree-variables.qmd)). We then facilitate the **filter()** method of the Management to specifically select this set of trees.
