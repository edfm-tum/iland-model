...
The API documentation for this object moved: [Factory object](../apidoc/classes/iland/factory.qmd).
...
Note that all other functions of the objects are preserved, e.g. the [Map](../apidoc/classes/iland/map.qmd) object is set to the "standard" stand-grid when initialized (constructor new-method). The same behavior is guaranteed when using the *Factory*.
...
**newMap()**
creates new instance of [Map](../apidoc/classes/iland/map.qmd)and returns it.
