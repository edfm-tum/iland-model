...
| **Name, Arguments** | **Description** | **Example** |
| --- | --- | --- |
| incsum(fn) | when used in SQL like expressions (e.g., [management](../apidoc/classes/management.qmd), the function *incsum* cumulates its value over several calls. See the management functions *mean* and *sum* functions. | incsum(basalArea)<40 |
