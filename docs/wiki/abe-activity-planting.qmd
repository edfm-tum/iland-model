...
Note that a direct-callable form of the planting activity exists ([fmengine.runPlanting()](http://iland-model.org/apidoc/classes/FMEngine.html#method_runPlanting)).
