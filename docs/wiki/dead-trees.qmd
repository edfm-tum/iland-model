...
Snags (both standing and downed) can be accessed via JavaScript (<https://iland-model.org/apidoc/classes/abe/deadtreelist.html>), and used for visualization in the UI and for custom outputs [link: dynamic outputs](dynamic-outputs.qmd)).
...
API-doc of *cell.deadTrees*: <https://iland-model.org/apidoc/classes/abe/deadtreelist.html>
