...
| `sprouting.adultSproutProbability` | numeric | `0` | **Adult Sprout Probability**: Annual probability that one adjacent 2x2m pixel is colonized by lateral sprouts of adult trees (>4m). |
