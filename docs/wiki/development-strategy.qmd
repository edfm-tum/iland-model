...
The overall iLand model design corresponds directly to its intended [domain of application](project-abstract.qmd). [Process resolution and level of complexity](iland-model-complexity-and-its-niche-in-the-landscape-of-models.qmd) are selected accordingly, yet taking feasability of implementation in the project duration into account. An initial model design overview can be [found here](how-it-works.qmd).
