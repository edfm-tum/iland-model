...
* The -+calculateSpeciesProbabilities()+- function determines first the basal area of each species on the stand ([using the -+stand+- object of the API](../apidoc/classes/abe/stand.qmd))
