...
The current implementation of BITE is coupled with the forest landscape simulation model [iLand](../index.qmd). See [iLand BITE](index.qmd).
...
![Bite](/img/bite_overview.png){width=600px}
...
### Main components
* [BiteEngine](biteengine.qmd): the Bite module
* [BiteAgent](biteagent.qmd): a biotic disturbance agent
* [BiteCell](bitecell.qmd): a single cell of an agent
* [expressions, events, variables](variables.qmd)
...
Item | Description
-----|----------
[BiteDispersal](bitedispersal.qmd) | dispersal of agents on the landscape from source cells
[BiteDistribution](bitedistribution.qmd) | availability of agents across the landscape (no spatial dispersal process)
[BiteColonization](bitecolonization.qmd) | the colonization of individual cells by the agent
[BiteBiomass](bitebiomass.qmd) | growth of biomass and mortality of agents on a cell
[BiteImpact](biteimpact.qmd) | the impact of an agent on the host vegetation on the cell (e.g. mortality of trees)
[BiteLifeCycle](bitelifecycle.qmd) | general agent properties such as voltinism
[BiteOutput](biteoutput.qmd) | cell level detailed outputs per agent

## Code examples

[BITE Example code](codeexamples.qmd)
