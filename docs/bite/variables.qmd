---
title: "Bite Variables, Expressions & Events"
---
...
expression. For instance, if the context are trees, then [tree variables](../wiki/tree-variables.qmd) 
...
either a [tree](../apidoc/classes/iland/tree.qmd) Javascript object (with a limited number of properties), or a
[cell object](bitecell.qmd). Note that the performance of Javascript functions is generally
