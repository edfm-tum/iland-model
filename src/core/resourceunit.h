...
{
    ResourceUnitVariables(): nitrogenAvailable(0.), cumCarbonUptake(0.), cumCarbonToAtm(0.), cumNEP(0.), carbonUptake(0.), carbonToAtm(0.), NEP(0.), isWaterlogged(false) {}
    ...
    bool isWaterlogged; ///< flag for resource units that are affected by waterlogging (true: waterlogged, false: not waterlogged)
};
