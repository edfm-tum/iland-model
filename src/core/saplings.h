...
public:
    ...
    // helpers
    /// used detailed light calculations to provide a grid of relative light at height height_at
    /// rGrid needs to be a grid with 2m resolution and is filled
    void generateLightMap(float height_at, Grid<float> &rGrid);
