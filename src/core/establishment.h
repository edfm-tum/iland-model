...
private:
    ...
    inline bool establishTree(const QPoint &pos_lif, const float lif_value, const float seed_value, MTRand &rnd); ///< do the final check whether a seedling can establish at given location
